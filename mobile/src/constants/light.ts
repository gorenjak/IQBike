...
export const GRADIENTS: ThemeGradients = {
  primary: ['#447352', '#447352'],
  secondary: ['#717171', '#717171'],
  info: ['#21D4FD', '#2152FF'],
  ...
  white: [String(COLORS.white), '#e7e7e7'],
  black: [String(COLORS.black), '#121212'],

  divider: ['#121212', '#121212'],
  menu: ['#121212', '#121212', '#121212'],
};
